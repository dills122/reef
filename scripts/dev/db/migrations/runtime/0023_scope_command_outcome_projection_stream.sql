-- Allow diagnostics/smokes to project one retained venue event stream without replaying
-- unrelated local benchmark streams that share partition ids and sequence ranges.
