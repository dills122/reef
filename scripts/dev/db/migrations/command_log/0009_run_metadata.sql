-- Add run/session attribution to durable command intake.
...
ALTER TABLE command_log.retention_pins
  DROP CONSTRAINT IF EXISTS retention_pins_selector_type_check;

ALTER TABLE command_log.retention_pins
  ADD CONSTRAINT retention_pins_selector_type_check
