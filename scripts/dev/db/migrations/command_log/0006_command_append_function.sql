-- Keep command intake, queue enqueue, and duplicate replay in one database call.
...
BEGIN
  ...
  IF v_inserted = 1 THEN
    INSERT INTO command_log.command_work_queue(command_id, status, attempt_count, last_error)
