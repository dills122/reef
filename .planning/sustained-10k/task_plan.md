...
- [ ] Run one clean C28-topology 10k/s x 300s treatment with `0062`+`0063`, preserve comparable timed stage/DB diagnostics and postdrain reference, then destroy the droplet. DigitalOcean saved `doctl` context returned 401 on September 25; access restoration is pending.
