...
| `/opt/reef/secrets/caddy.env` | `ADMIN_API_TOKEN`, `ARENA_ADMIN_API_TOKEN`, `ANALYTICS_EXPORT_API_TOKEN` | Caddy public admin gateway and platform runtime route checks |
