...
object RuntimeDataSources {
    ...
    private fun defaultMaximumPoolSize(poolName: String, globalDefault: Int): Int {
        return when (poolName) {
            ...
            "runtime-projection", "async-runtime-projection" -> globalDefault.coerceAtMost(16)
            "stream-runtime-projection" -> globalDefault.coerceAtLeast(24)
    ...
    private fun defaultMinimumIdle(poolName: String, globalDefault: Int, maximumPoolSize: Int): Int {
        val roleDefault = when (poolName) {
            ...
            "stream-intake", "stream-runtime", "stream-runtime-projection" -> globalDefault.coerceAtLeast(8)
            "runtime-projection", "async-runtime-projection" -> globalDefault.coerceAtMost(4)
