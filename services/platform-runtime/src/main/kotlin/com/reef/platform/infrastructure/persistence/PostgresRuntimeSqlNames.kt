...
data class PostgresRuntimeSqlNames(
    ...
    val projectionBatchClaims = qualify(runtimeSchemaName, "projection_batch_claims")
    val projectionBatchClaimFrontiers = qualify(runtimeSchemaName, "projection_batch_claim_frontiers")
    ...
    val rejectExecutionReplayConflictFunction = qualify(runtimeSchemaName, "runtime_reject_execution_replay_conflict")
    ...
    val projectionBatchIdentityV1Function = qualify(runtimeSchemaName, "runtime_projection_batch_identity_v1")
    val claimProjectionBatchV1Function = qualify(runtimeSchemaName, "runtime_claim_projection_batch_v1")
    val completeProjectionBatchV1Function = qualify(runtimeSchemaName, "runtime_complete_projection_batch_v1")
