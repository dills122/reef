...
class PlatformHttpServer(
    ...
    // Settlement fact ingestion, repair/force-settle/ledger-reversal, and the
    // facts/obligations/ledger/proof/score query surface all live in
    // SettlementAdminGateway.kt (see field above).
