...
- **Kafka-compatible durable log (Redpanda)** as the active high-throughput accepted-command ingress and venue event backbone, with **NATS/JetStream** retained as a fallback/comparison provider
