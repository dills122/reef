...
- exception queue: one `SETTLEMENT_BREAK` row, `RESOLVED`, zero open rows, `ownerRole = SETTLEMENT_OPS`, `actionRequired = NONE`, and repair action matching the break reason
