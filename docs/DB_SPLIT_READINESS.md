...
3. Convert runtime fact columns that are still stored as text into typed Postgres facts.
   ...
   - Checkpoint: `runtime/0028_typed_top_of_book_facts.sql` adds typed numeric companion columns for top-of-book lifecycle and market-data projection facts; broader runtime fact typing remains open.
