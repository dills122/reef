...
the [C28 diagnostic](THROUGHPUT_BASELINES.md#c28--same-prefix-marker-timing-full-projection-10k-diagnostic)
and [C37 reproduction](THROUGHPUT_BASELINES.md#c37--fresh-reproduction-of-best-10k-full-system-c28-setup-diagnostic-fail)
failed downstream timing or freshness. Treat intake latency, canonical
