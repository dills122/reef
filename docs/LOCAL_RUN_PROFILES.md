...
| **10k/s through materializers and canonical projection, diagnostic**: [C28](THROUGHPUT_BASELINES.md#c28--same-prefix-marker-timing-full-projection-10k-diagnostic) | DigitalOcean c-32 (32 vCPU/64 GB); 16 partitions, four materializers, 16 canonical writers, four grouped lifecycle loops on one maintainer plus market's nested caller; projection batches of 500; 256 load workers; 64 instruments; 10k/s for 300s. Primary/projection max connections 512/512; projection shared buffers 2 GB. | 2,999,868 accepted/materialized/canonically projected by final drain, with zero final gap; report's projected rate was 9,998.94/s **including drain**. Lifecycle/market conservative p95 bounds were 6,314/7,315 ms against a 5,000 ms gate. Full business reference was deferred. This is the best recorded 10k full-pipeline topology, but its freshness gate **failed**. |
...
An earlier [C22 c-32 diagnostic](THROUGHPUT_BASELINES.md#c22--c-32-full-projection10k-capacity-diagnostic-qualification-still-fails)
also reached 2,999,950 accepted/materialized/projected after drain (reported
9,999.77/s), with a passing full business reference. It used four separate
lifecycle maintainers rather than C28's grouped loops; current authority
checks reject that ownership, and its lifecycle/market conservative p95 bounds
were 6,711/7,720 ms. Preserve that result as evidence, not as a qualified
configuration. The [C22 aggregate](evidence/throughput-10000-capacity-2026-09-24.json)
and [C28 aggregate](evidence/throughput-prefix-attribution-c28-2026-09-24.json)
hold the original report hashes and measured rates.
