...
4. Complete venue lifecycle projection.
   ...
   - 2026-07-12 short projection evidence: after splitting four projector instances across active direct-stream partitions `0-15`, DO run `do-benchmark-20260712T163041Z` passed at `2.5k rps` on c-16 with `149,977` accepted/materialized/projected commands, projected rps `2499.59`, p95 `18.35ms`, p99 `44.26ms`, and projection lag `0`. Follow-up hardening now gates projection-postgres deadlocks explicitly.
