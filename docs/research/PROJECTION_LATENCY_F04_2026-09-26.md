...
No new F04 hosted run was started after this stopping point. The F02 disposable droplet should be destroyed after local evidence verification; provision a fresh host for the next controlled trial.
