...
9. Keep Bot Arena Phase 1 moving without overlapping the real-time stress dashboard work: local arena run evidence, persisted positive/negative gates, static operator reports, then hosted/backbone gate planning.
