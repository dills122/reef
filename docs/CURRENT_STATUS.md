...
- Exploratory `20k-50k` venue-core scaling review and promotion ladder (not yet an accepted decision): [`THROUGHPUT_SCALING_20K_50K_INVESTIGATION.md`](./THROUGHPUT_SCALING_20K_50K_INVESTIGATION.md)
- Active fault-line hardening and promotion work order: [`THROUGHPUT_SCALING_IMPLEMENTATION_PLAN.md`](./THROUGHPUT_SCALING_IMPLEMENTATION_PLAN.md)
