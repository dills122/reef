...
Work should follow this order unless a new decision supersedes it. The active checkpoint is durable direct path hardening: local API marker, engine, materializer, projector, and replay proof exists; longer remote soak evidence still gates promotion.
