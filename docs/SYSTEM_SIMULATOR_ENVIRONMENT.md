...
| Projection proof | `make dev-smoke-projection-proof` | Direct engine consume, durable event batch publish, Postgres materialization, background projection into the projection database, read APIs, and data availability metadata. |
