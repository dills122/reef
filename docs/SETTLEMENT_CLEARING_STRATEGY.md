...
- Current implementation has partial calendar/settlement-cycle admin configuration and the P2 settlement fact slice. Full post-trade profile policy storage and selection are still planned.
