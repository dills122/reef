...
banner:
  content: Limited preview. Invite-only admission and onboarding have completed their external-account test; recorded-game release requirements remain, and open self-service intake is later.
---
